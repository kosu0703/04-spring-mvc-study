	...
	<form method="post" enctype="multipart/form-data">
		<table style="margin: 0 auto; width: 900px;">
			<tbody>
				...
				<tr>
					<td colspan="2"><input type="hidden" name="cPage"
						value="${cPage}"> <input type="button" value="입력"
						onclick="board_write_ok(this.form)" /> &nbsp;&nbsp;&nbsp;&nbsp; <input
						type="reset" value="지우기" /> &nbsp;&nbsp;&nbsp;&nbsp; <input
						type="button" value="목록" onclick="board_list(this.form)" /></td>
				</tr>
			</tbody>
		</table>
	</form>
