 ...
 * Generated at: 2024-04-03 01:05:21 UTC
...
public final class ajax_005fexam2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			$.ajax({\r\n");
      out.write("				url : \"getAjaxList.do\",\r\n");
      out.write("				method : \"post\", // 다른방식 => type : \"post\"\r\n");
      out.write("				dataType : \"xml\",\r\n");
      out.write("				success : function(data) {\r\n");
      out.write("					let tbody = \"\";\r\n");
      out.write("					$(data).find(\"member\").each(function() {\r\n");
      out.write("						let m_idx = $(this).find(\"m_idx\").text();\r\n");
      out.write("						let m_id = $(this).find(\"m_id\").text();\r\n");
      out.write("						let m_pw = $(this).find(\"m_pw\").text();\r\n");
      out.write("						let m_name = $(this).find(\"m_name\").text();\r\n");
      out.write("						let m_age = $(this).find(\"m_age\").text();\r\n");
      out.write("						let m_reg = $(this).find(\"m_reg\").text();\r\n");
      out.write("						tbody += \"<tr>\";\r\n");
      out.write("						tbody += \"<td>\" + m_idx + \"</td>\";\r\n");
      out.write("						tbody += \"<td>\" + m_id + \"</td>\";\r\n");
      out.write("						tbody += \"<td>\" + m_pw + \"</td>\";\r\n");
      out.write("						tbody += \"<td>\" + m_name + \"</td>\";\r\n");
      out.write("						tbody += \"<td>\" + m_age + \"</td>\";\r\n");
      out.write("						tbody += \"<td>\" + m_reg + \"</td>\";\r\n");
      out.write("						\r\n");
      ...
      out.write("									$(this).find(\"m_idx\").text()\r\n");
      out.write("									+ \"'></td>\";\r\n");
      out.write("						\r\n");
      out.write("						tbody += \"</tr>\";\r\n");
      out.write("					});\r\n");
      ...
      out.write("						//	가입성공\r\n");
      out.write("						$(\"#myform\").find(\"input\").val.text(\"\");\r\n");
      ...
      out.write("                    <td>\r\n");
      out.write("                    	<!-- id 키를 누르면 -->\r\n");
      out.write("                        <input type=\"text\" size=\"14\" name=\"m_id\" id=\"m_id\">\r\n");
      ...
      out.write("                    <td><input type=\"number\" size=\"12\" name=\"m_age\"></td>  \r\n");
      out.write("                </tr>\r\n");
      out.write("            </tbody>\r\n");
      out.write("            <tfoot>\r\n");
