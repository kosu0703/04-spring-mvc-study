...
public class GuestBook2Controller {
	...
	public ModelAndView getGuestBook2WriteOK(GuestBook2VO vo, HttpSession session) {
		try {
	...
	public ModelAndView getGuestBook2UpdateOK(GuestBook2VO vo, HttpSession session) {
		ModelAndView mv = new ModelAndView();
